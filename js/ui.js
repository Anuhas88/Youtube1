...
const UI = {
    ...
    elements: {
        ...
        closeModelBtn: document.getElementById('clse-modal-btn'),
    ...
    init: function () {
        ...
        if(this.elements.closeModelBtn){
            this.elements.closeModelBtn.addEventListener('click', this.hideVideoModal.bind(this));
        }
    },
    ...
    openVideoModel: function(videoId){
       if(this.elements.videoModal)
        return;

       this.elements.videoContainer.innerHTML = `
            <iframe width="100%" height="100%" src="https://www.youtube.com/embed/${videoId}?autoplay=1" title="YouTube video player" frameborder="0" allow="autoplay; clipboard-write; encrypted-media; gyroscope;
